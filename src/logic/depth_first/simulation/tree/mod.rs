    ...
    Node: DNode,
{
    ...
    fn simulate(&mut self, duration: Duration) {
...
mod tests {
    ...
    use crate::{
        logic::depth_first::{
            ...
            simulation::{
                d_node_id::DNodeId, node::d_pessimistic_capture_node::DPessimisticCaptureNode,
                tree::DTree,
            },
        },
        read_game_state,
    ...
    fn test_simulate_with_pessimistic_capture_node() {
        ...
        tree.simulate(Duration::from_millis(20000000));
        println!("{}", tree);
    }
}
