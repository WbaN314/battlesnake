...
situation_test!(failure_63, Right => "Grabbing food is probably too risky, right is the only way out");
...
situation_test!(failure_66, Down, Right => "Left would be ProbablyDead with D");
...
situation_test!(failure_71, Right => "Longest survival, but all choices are bad");
